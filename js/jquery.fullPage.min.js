...
function exTickerLoop(){
	...
	$(".scrolling-text-wrapper").each(function(){				
		exWidths.push($(this).find(".scrolling-text").width());
		counters.push(0);
	});
	var scrollingtimer = setInterval(function(){
		$(".scrolling-text-wrapper").each(function(){
			...
			if (counters[current] >= (exWidths[current]*2)){
				counters[current] = 0;
			}
			else{					
			...
			if (directon == "pos"){
				...
				var width = $(this).find(".scrolling-text").width()*10;
				$(this).css("-moz-transform", "translate(-"+counters[current]+"px, 0)");
				$(this).css("-moz-transform", "translate(-"+counters[current]+"px, 0)");
				$(this).css("-o-transform", "translate(-"+counters[current]+"px, 0)");
				$(this).css("-ms-transform", "translate(-"+counters[current]+"px, 0)");
	...
	window.scrollingTimers.push(scrollingtimer);	
}
...
function populateExTicker() {
	$(".scrolling-text-wrapper").each(function() {		
		...
		var fullWidth = $(this).find(".scrolling-text").width()*ntotal;
		if (directon == "neg"){
